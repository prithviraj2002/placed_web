          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Text(PlacedStrings.postAJob,
                  style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.w800, color: PlacedColors.PrimaryBlack),),
              ),
              Container(
                height: 830,
                            ...
                            children: <Widget>[
                              OutlinedButton(onPressed: () {
                                controller.uploadPhoto();
                                  ...
                                  child: Text(PlacedStrings.uploadLogo,
                              ...
                              Text('PNG, JPG and JPEG are supported',
                                style: GoogleFonts.poppins(
                                  fontSize: 16,
                                  fontWeight: FontWeight.w700,
